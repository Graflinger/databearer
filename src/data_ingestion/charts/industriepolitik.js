...
module.exports = [
  // Battery and PV price (multi-line)
  {
    ...
    xKey: 'jahr',
    seriesKeys: ['Solar Modul Kosten in USD pro kWh', 'Batterie Preis in USD pro kW'],
  ...
  // EV market share (multi-line)
  {
    ...
    xKey: 'jahr',
    seriesKeys: ['European Union (27)', 'China', 'United States', 'Norway', 'Germany', 'World'],
  ...
  // Electrification rate (multi-line)
  {
    ...
    xKey: 'jahr',
    seriesKeys: ['European Union (27)', 'China', 'United States', 'Norway', 'Germany'],
