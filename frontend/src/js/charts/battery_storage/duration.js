(function() {
  const chartDom = document.getElementById('battery-storage-duration');
  if (!chartDom) {
    console.error('Chart container "battery-storage-duration" not found');
    return;
  }
