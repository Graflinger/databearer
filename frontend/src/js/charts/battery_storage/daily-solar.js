(function() {
  const chartDom = document.getElementById('battery-storage-daily-solar');
  if (!chartDom) {
    console.error('Chart container "battery-storage-daily-solar" not found');
    return;
  }
