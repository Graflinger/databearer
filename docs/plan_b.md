...
Status: alternatives for later evaluation; none is required or implemented by this
document. The default remains [the stateless daily architecture](dashboard_architecture.md).
