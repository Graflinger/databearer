...
| `strompreis-korrelation` | story | in review | `feature/strompreis-gas-erneuerbare-korrelation` | [#44](https://github.com/Graflinger/databearer/pull/44) | [strompreis_korrelation.md](strompreis_korrelation.md) | Review the article `/posts/2026/strompreis-gaspreis-erneuerbare/` (seasonality caveat, monthly-TTF scope, card image), then merge. Public-facing: add #44 to `release-promotion` on merge. |
